class Api < ApplicationRecord
    ...
    def self.fetch_set_by_set_num(set_num, theme = nil) # optional theme argument
        ...
        if !data.empty?
            ...
            lego_set = theme.lego_sets.create(set_number: data["set_num"], year: data["year"], image_url: data["set_img_url"], name: data["name"], instructions_url: "https://rebrickable.com/instructions/#{set_num}", total_bricks: data["num_parts"], owned: false, potential_build: false, potential_build_strict: false)
        end
    end
